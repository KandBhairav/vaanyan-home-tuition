...
# Configuration
app.config['SECRET_KEY'] = 'vaanyan-home-tuition-secret-key-2025'
...
app.config['MAIL_USERNAME'] = 'mahapatravinayak@gmail.com'
app.config['MAIL_PASSWORD'] = 'wrdb okdi macb zxim'
app.config['ADMIN_EMAIL'] = 'mahapatravinayak@gmail.com'
...
def create_sample_data():
    ...
    teacher1_profile = TeacherProfile(
        ...
        teaching_mode='home_tuition,online',
        hourly_rate=500,
        bio='Experienced Math and Physics teacher with 8 years of teaching experience',
        city='Dehradun',
    ...
    student1_profile = StudentProfile(
        ...
        city='Dehradun',
        address='456 Student Street, Dehradun'
    )
